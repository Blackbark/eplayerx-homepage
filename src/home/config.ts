...
interface HomePagination { pageParam: string; startPage: number; }
...
const TITLE_TRANSLATIONS: Record<HomeTitleKey, Record<Locale, string>> = {
  ...
  "home.trakt_movies": { en: "火爆全球的欧美大片", zh: "火爆全球的欧美大片", "zh-Hant": "火爆全球的欧美大片", ja: "火爆全球的欧美大片", es: "火爆全球的欧美大片", ar: "火爆全球的欧美大片" },
  "home.trakt_shows": { en: "时下热播的欧美剧集", zh: "时下热播的欧美剧集", "zh-Hant": "时下热播的欧美剧集", ja: "时下热播的欧美剧集", es: "时下热播的欧美剧集", ar: "时下热播的欧美剧集" },
  "home.douban_movies": { en: "实时热门电影", zh: "实时热门电影", "zh-Hant": "实时热门电影", ja: "实时热门电影", es: "实时热门电影", ar: "实时热门电影" },
  "home.douban_tv": { en: "时下最热门的国产剧", zh: "时下最热门的国产剧", "zh-Hant": "时下最热门的国产剧", ja: "时下最热门的国产剧", es: "时下最热门的国产剧", ar: "时下最热门的国产剧" },
  "home.douban_hot_variety": { en: "实时热门综艺", zh: "实时热门综艺", "zh-Hant": "实时热门综艺", ja: "实时热门综艺", es: "实时热门综艺", ar: "实时热门综艺" },
  "home.douban_korean_tv": { en: "备受欢迎的韩剧推荐", zh: "备受欢迎的韩剧推荐", "zh-Hant": "备受欢迎的韩剧推荐", ja: "备受欢迎的韩剧推荐", es: "备受欢迎的韩剧推荐", ar: "备受欢迎的韩剧推荐" },
  "home.tmdb_tv_ja": { en: "近期最流行日剧榜单", zh: "近期最流行日剧榜单", "zh-Hant": "近期最流行日剧榜单", ja: "近期最流行日剧榜单", es: "近期最流行日剧榜单", ar: "近期最流行日剧榜单" },
  "home.tmdb_tv_th": { en: "萨瓦迪卡热门泰剧推荐", zh: "萨瓦迪卡热门泰剧推荐", "zh-Hant": "萨瓦迪卡热门泰剧推荐", ja: "萨瓦迪卡热门泰剧推荐", es: "萨瓦迪卡热门泰剧推荐", ar: "萨瓦迪卡热门泰剧推荐" },
  "home.tmdb_anime_jp": { en: "不可错过的热门日漫", zh: "不可错过的热门日漫", "zh-Hant": "不可错过的热门日漫", ja: "不可错过的热门日漫", es: "不可错过的热门日漫", ar: "不可错过的热门日漫" },
  "home.tmdb_anime_cn": { en: "热血沸腾的国漫精选", zh: "热血沸腾的国漫精选", "zh-Hant": "热血沸腾的国漫精选", ja: "热血沸腾的国漫精选", es: "热血沸腾的国漫精选", ar: "热血沸腾的国漫精选" },
  "home.tmdb_movie_th": { en: "值得一看的泰国好电影", zh: "值得一看的泰国好电影", "zh-Hant": "值得一看的泰国好电影", ja: "值得一看的泰国好电影", es: "值得一看的泰国好电影", ar: "值得一看的泰国好电影" },
  "home.tmdb_movie_sea": { en: "别具一格的东南亚佳作", zh: "别具一格的东南亚佳作", "zh-Hant": "别具一格的东南亚佳作", ja: "别具一格的东南亚佳作", es: "别具一格的东南亚佳作", ar: "别具一格的东南亚佳作" },
  "home.tmdb_tv_es": { en: "时下流行的西语剧集", zh: "时下流行的西语剧集", "zh-Hant": "时下流行的西语剧集", ja: "时下流行的西语剧集", es: "时下流行的西语剧集", ar: "时下流行的西语剧集" },
};
